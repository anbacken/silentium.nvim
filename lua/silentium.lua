...
function M.colorscheme()
	...
	hl("NormalFloat", { bg = M.colors.dark, fg = M.colors.white })
	...
	hl("StatusLine", { bg = M.colors.dark, fg = M.colors.accent })
	hl("StatusLineNC", { bg = M.colors.dark, fg = M.colors.accent })
	...
	-- Snacks
	-- Dashboard
	hl("SnacksDashboardDesc", { fg = M.colors.white })
	hl("SnacksDashboardFooter", { fg = M.colors.gray })
	hl("SnacksDashboardHeader", { fg = M.colors.accent })
	hl("SnacksDashboardIcon", { fg = M.colors.white })
	hl("SnacksDashboardKey", { fg = M.colors.white })
	hl("SnacksDashboardSpecial", { fg = M.colors.white })
	hl("SnacksDashboardDir", { fg = M.colors.white })
	-- Picker
	hl("SnacksPickerInputBorder", { fg = M.colors.accent, bg = M.colors.dark })
	hl("SnacksPickerInputTitle", { fg = M.colors.white, bg = M.colors.dark })
	hl("SnacksPickerBoxTitle", { fg = M.colors.white, bg = M.colors.dark })
	hl("SnacksPickerSelected", { fg = M.colors.white })
	hl("SnacksPickerToggle", { fg = M.colors.white, bg = M.colors.dark })
	hl("SnacksPickerPickWinCurrent", { fg = M.colors.white, bg = M.colors.dark, bold = true })
	hl("SnacksPickerPickWin", { fg = M.colors.white, bg = M.colors.dark, bold = true })
	hl("SnacksPickerDir", { fg = M.colors.gray, bg = M.colors.dark, bold = true })
	hl("SnacksPickerFile", { fg = M.colors.white, bg = M.colors.dark, bold = true })
	hl("SnacksPickerTotals", { fg = M.colors.gray, bg = M.colors.dark })
end
